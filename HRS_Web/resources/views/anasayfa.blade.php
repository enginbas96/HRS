...
<html lang="en">
<head>
    <title>Anasayfa | ABC Özel Sağlık Hizmetleri Randevu Sistemi</title>
        ...
        <div class="row">
            ...
            <div class="owl-carousel owl-theme">
                <div class="item item-first">
                    <div class="caption">
                        <div class="col-md-offset-1 col-md-10">
                            <h3>Aradığınız doktor bu hastanede olabilir</h3>
                            <h1>Uzman doktor kadromuzu gördünüz mü?</h1>
                            <a href="{{route("doktorlarSayfasi")}}" class="section-btn btn btn-default smoothScroll">Doktorlarımız
                                ile tanışın</a>
                        </div>
                    </div>
                </div>
                <div class="item item-second">
                    <div class="caption">
                        <div class="col-md-offset-1 col-md-10">
                            <h3>Daha önce karşılaştık mı?</h3>
                            <h1>Eminim bizi çok seveceksin.</h1>
                            <a href="{{route("hakkimizdaSayfasi")}}"
                               class="section-btn btn btn-default btn-gray smoothScroll">Hakkımızda daha fazlası</a>
                        </div>
                    </div>
                </div>
            </div>
