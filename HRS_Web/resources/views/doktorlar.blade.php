...
<html lang="en">
<head>
    <title>Doktorlarımız | ABC Özel Sağlık Hizmetleri Randevu Sistemi</title>
...
<section id="appointment" data-stellar-background-ratio="3">
    <div class="container">
        <div class="row">
            ...
            @if($doktor->isEmpty())
            @else
                @foreach($doktor as $doktorBilgileri)
                    <div class="col-md-4">
                        <div class="appointment-item-doktorlar">
                            <p><strong>Doktor : </strong> {{ $doktorBilgileri->unvan }} {{ $doktorBilgileri->adsoyad }}
                            </p>
                            <p><strong>E-Posta : </strong> {{ $doktorBilgileri->eposta }}</p>
                            <p><strong>Poliklinik : </strong> {{ $doktorBilgileri->birim }}</p>
                            <p><strong>Hastane : </strong>{{ $doktorBilgileri->hastaneAdi }}</p>
                        </div>
                    </div>
                @endforeach
            @endif
